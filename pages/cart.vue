...
export default {
  data() {
    return {
      cartItems: [
        { name: 'Jam Tangan', price: 300000, quantity: 1 },
        { name: 'Tas', price: 200000, quantity: 2 },
        { name: 'Sepatu', price: 170000, quantity: 3 },
        { name: 'Buku Tulis', price: 100000, quantity: 3 },
        { name: 'Pensil', price: 100000, quantity: 3 },
        { name: 'Tempat Pensil', price: 100000, quantity: 3 },
        { name: 'Seragam', price: 100000, quantity: 3 },
        { name: 'Kaus Kaki', price: 100000, quantity: 3 },
